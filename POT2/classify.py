...
def classify(classnames):
    ...
    text_language = [ 'aeroplane', 'bicycle', 'bird', 'boat', 'bottle',
                     'bus', 'car', 'cat', 'chair', 'cow',
                     'diningtable', 'dog', 'horse', 'motorbike', "person with clothes,people,human",
                     'pottedplant', 'sheep', 'sofa', 'train', 'tvmonitor', 'ground', 'land', 'grass', 'tree',
                     'building', 'wall', 'sky', 'lake', 'water', 'river', 'sea', 'railway', 'railroad', 'keyboard',
                     'helmet',
...
if __name__ == "__main__":
    ...
    parser.add_argument('--img_root', type=str, default='/gpfs/work/int/jiawang21/code/data/VOCdevkit/VOC2012/JPEGImages')
    parser.add_argument('--split_file', type=str, default='./imageset/voc2012/toytest.txt')
    parser.add_argument('--model_path', type=str, default='../../CLIP-ES/pretrained_models/ViT-B-16.pt')
    ...
    print("device:", device)
    print('================================================\n')
    model, _ = clip2.load(args.model_path, device=device)
    model.eval()
