BACKGROUND_CATEGORY_VOC = ['ground', 'land', 'grass', 'tree', 'building', 'wall', 'sky', 'lake', 'water', 'river',
...
coco_stuff_categories = [
    ...
    "appliance",  # 1
    "food things",
    # 2, food-things, i.e., cake, donut, pizza, hot dog, carrot, broccoli, orange, sandwich, apple, and banana
