...
if __name__ == '__main__':
    ...
    parser.add_argument("--voc12_root", default='/gpfs/work/int/xianglinqiu20/wj/data/VOCdevkit/VOC2012', type=str)
    parser.add_argument("--gt_dir", default='/gpfs/work/int/xianglinqiu20/wj/data/VOCdevkit/VOC2012/SegmentationClass', type=str)
