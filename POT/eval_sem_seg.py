...
if __name__ == '__main__':
    ...
    parser.add_argument("--gt_dir", default='/gpfs/work/int/jiawang21/code/data/VOCdevkit/VOC2012/SegmentationClass', type=str)
    parser.add_argument("--chainer_eval_set", default="train", type=str)
    # parser.add_argument("--sem_seg_out_dir", default="exp_clip/pseudo_label", type=str)
    parser.add_argument("--sem_seg_out_dir", default="exp_clip/pseudo_label_fig4", type=str)
